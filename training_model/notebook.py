...
DATA_PATH = kagglehub.dataset_download("andrewmvd/road-sign-detection")
   
# XML File Content
# file= open(os.path.join(DATA_PATH, "annotations", "road4.xml"), 'r')
# print(file.read())
...
print(DATA_PATH)
ANNOTATION_DIR = Path(DATA_PATH).joinpath("annotations") 
info_dict = extract_info_from_xml(ANNOTATION_DIR.joinpath("road4.xml"))
